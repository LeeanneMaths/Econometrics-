...
w = 0.4076;      % Wage rate
Psi = 0.40;      % Updated replacement rate (from 30% to 40%)
...
% System of equations with updated PAYG program
...
% Display the results
fprintf('Life-Cycle Consumption Profile with PAYG (40%% replacement rate):\n');
fprintf('c1 = %.4f, c2 = %.4f, c3 = %.4f, c4 = %.4f\n', c1, c2, c3, c4);
fprintf('Life-Cycle Savings Profile with PAYG (40%% replacement rate):\n');
